...
* `compile: crtbndrpg` to run the CRTBNDRPG option
* `compile: crtrpgmod` to run the CRTRPGMOD option

You can also see it being used in the screenshot above. When using the Live Errors feature, **it will also default to that compile option** so you do not have to keep selecting it from the dropdown.
