...
ILEditor 2 needs a temp library to store information for your working session. If there are multiple people in a company using ILEditor 2, it is recommended that they all share the same Temp Library. This library can be cleared regularly as may build up in storage, without affecting any connections.
